                        ...
                        <div class="poster-root-box">
                            <div class="d-flex align-items-center justify-content-center gap-4">
                                ...
                                @if($rootPerson->spouses->isNotEmpty())
                                    <div class="text-white fw-bold fs-5">{{ __('and') }}</div>
                                    <!-- Spouses -->
                            ...
                            @foreach($allChildren as $index => $child)
                                ...
                                <div class="column-block" style="background-color: {{ $bgColor }};">
                                    <div class="column-header">
                                        ...
                                        <div class="text-muted small">{{ $child->birth_year ?? '?' }} - {{ $child->death_year ?? __('Present') }}</div>
                                    </div>
                                    
                                    <div class="descendants-list">
                                        <div class="text-center mb-3">
                                            <strong class="border-bottom border-dark pb-1">{{ $child->first_name }} {{ __('descendants') }}</strong>
                                        </div>
